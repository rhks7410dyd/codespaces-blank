...
1. 종만북 1권 + solved.ac 2,3 클래스 문제로 기초 다지기 (~5월)
...
# 휴가
확정 -> 19일(연가 10 + 위로 3 + 백신 2 + 분대장 4) -> 목표 : 22일
포상 : 백신 2일 + "전준태 4일" + 혹한기 행군 1일 + "5관 3략 100일" + 5관 3략 200일 (9) (+분대장 4일 (13))

총 휴가 : 연가 24일 + 포상 16일 + 위로(총 3일) = 43일(잔여 31)

1차 정기 휴가 : 연가 7일 + 포상 5일(12일) <- 4/3 ~ 4/14

2차 정기 휴가 : 연가 7일 (이걸 아마 7월에 나가야될듯)
